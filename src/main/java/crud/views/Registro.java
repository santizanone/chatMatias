...
private String photoPath = "";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 290, 20));
        ...
        jButton3.setText("Foto de Perfil");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String username = jTextField3.getText();
        ...
        if (username.equals("") || password.equals("") || photoPath.equals("")){
            JOptionPane.showMessageDialog(null, "Complete todos los datos");
            return;
        }
        controller.registerUser(new UserDto(username, password,-1,photoPath));
